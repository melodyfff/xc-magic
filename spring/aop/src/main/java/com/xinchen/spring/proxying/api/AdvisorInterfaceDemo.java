...
/**
 *
 * 基于xml的demo,代理的是接口类型,具体在spring-proxy-interface.xml中查看
 *
 ...
 */
public class AdvisorInterfaceDemo {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:proxy/spring-proxy-interface.xml");
