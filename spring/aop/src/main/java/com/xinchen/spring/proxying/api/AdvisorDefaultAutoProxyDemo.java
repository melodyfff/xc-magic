 ...
 */
public class AdvisorDefaultAutoProxyDemo {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:proxy/spring-proxy-default-autoproxy.xml");
