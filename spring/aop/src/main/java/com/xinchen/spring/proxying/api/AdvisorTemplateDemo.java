...
/**
 *
 * 基于xml的demo,基于模板进行代理,代理的是类,具体在spring-proxy-template.xml中查看
 *
 * 如果不开启cglib则会报错
 * <pre>
 ...
 */
public class AdvisorTemplateDemo {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:proxy/spring-proxy-template.xml");
