...
/**
 *
 * 基于xml的demo,代理的是类,具体在spring-proxy-beanname-autoproxy.xml中查看
 *
 * 如果不开启cglib则会报错
 * <pre>
 ...
 */
public class AdvisorBeanNameAutoProxyDemo {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:proxy/spring-proxy-beanname-autoproxy.xml");
        Person person = (Person) context.getBean("personService");
